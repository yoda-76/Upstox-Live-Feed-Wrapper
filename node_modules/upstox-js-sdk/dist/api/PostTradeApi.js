...
class PostTradeApi {
  ...
  */
  ...
  getTradesByDateRange(startDate, endDate, pageNumber, pageSize, opts, callback) {
    ...
    let contentTypes = [];
    let accepts = ['*/*'];
    let returnType = _TradeHistoryResponse.TradeHistoryResponse;
    return this.apiClient.callApi('/v2/charges/historical-trades', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
}
exports.PostTradeApi = PostTradeApi;