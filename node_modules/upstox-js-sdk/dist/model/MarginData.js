...
class MarginData {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('margins')) obj.margins = _ApiClient.ApiClient.convertToType(data['margins'], [_Margin.Margin]);
      if (data.hasOwnProperty('required_margin')) obj.requiredMargin = _ApiClient.ApiClient.convertToType(data['required_margin'], 'Number');
      if (data.hasOwnProperty('final_margin')) obj.finalMargin = _ApiClient.ApiClient.convertToType(data['final_margin'], 'Number');
    }
    return obj;
  }
}
