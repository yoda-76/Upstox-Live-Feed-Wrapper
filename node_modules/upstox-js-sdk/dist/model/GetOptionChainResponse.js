...
exports.GetOptionChainResponse = void 0;
var _ApiClient = require("../ApiClient");
var _OptionStrikeData = require("./OptionStrikeData");
/*
 * OpenAPI definition
...
class GetOptionChainResponse {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data')) obj.data = _ApiClient.ApiClient.convertToType(data['data'], [_OptionStrikeData.OptionStrikeData]);
    }
    return obj;
  }
}
 ...
 * @readonly
 */
exports.GetOptionChainResponse = GetOptionChainResponse;
