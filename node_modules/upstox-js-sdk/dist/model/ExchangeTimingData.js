...
exports.ExchangeTimingData = void 0;
...
class ExchangeTimingData {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('start_time')) obj.startTime = _ApiClient.ApiClient.convertToType(data['start_time'], 'Number');
      if (data.hasOwnProperty('end_time')) obj.endTime = _ApiClient.ApiClient.convertToType(data['end_time'], 'Number');
    }
    return obj;
  }
}
 ...
 */
exports.ExchangeTimingData = ExchangeTimingData;
