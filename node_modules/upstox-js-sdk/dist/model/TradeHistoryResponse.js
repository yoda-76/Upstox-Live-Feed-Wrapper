...
exports.TradeHistoryResponse = void 0;
var _ApiClient = require("../ApiClient");
var _TradeHistoryResponseMetaData = require("./TradeHistoryResponseMetaData");
var _TradeHistoryResponseTradeData = require("./TradeHistoryResponseTradeData");
/*
 * OpenAPI definition
...
class TradeHistoryResponse {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data')) obj.data = _ApiClient.ApiClient.convertToType(data['data'], [_TradeHistoryResponseTradeData.TradeHistoryResponseTradeData]);
      if (data.hasOwnProperty('metaData')) obj.metaData = _TradeHistoryResponseMetaData.TradeHistoryResponseMetaData.constructFromObject(data['metaData']);
    }
    return obj;
  }
}
