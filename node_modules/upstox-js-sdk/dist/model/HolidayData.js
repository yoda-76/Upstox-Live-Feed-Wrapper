...
var _ExchangeTimingData = require("./ExchangeTimingData");
/*
 * OpenAPI definition
...
class HolidayData {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('holiday_type')) obj.holidayType = _ApiClient.ApiClient.convertToType(data['holiday_type'], 'String');
      if (data.hasOwnProperty('closed_exchanges')) obj.closedExchanges = _ApiClient.ApiClient.convertToType(data['closed_exchanges'], ['String']);
      if (data.hasOwnProperty('open_exchanges')) obj.openExchanges = _ApiClient.ApiClient.convertToType(data['open_exchanges'], [_ExchangeTimingData.ExchangeTimingData]);
    }
    return obj;
  }
}
 ...
 * @member {Date} _date
 */
exports.HolidayData = HolidayData;
